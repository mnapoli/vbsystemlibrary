...
<!-- Contenu de la page -->
	...
	<!-- Pour les débutants -->
	<?
		$WindowTitle = "Liste des membres";
		include "windowtop.php";
		?>
			<p>
				Vous pouvez également voir <a href="listadmins.php">la liste des admins</a>.
			</p>
			<div align="center"><br />
			<table cellspacing="4" class="ListeMembres">
				...
				<?php
					// Cherche la liste
					if (@dbConnect() !=0) {
						$req = "SELECT `ID`, `Name`, `PublicMail`, `Avatar`, `Website` FROM `users` WHERE `Actif` = '1' ORDER BY `ID` ASC";
						...
						echo "Impossible d'afficher la liste des membres";
					}
				?>
			</table>
			</div><br />
