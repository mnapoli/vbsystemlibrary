...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		allRTEs += rte;
		writeRTE(rte, html, width, height, buttons, readOnly, 'FR');
	} else {
...
function writeRTE(rte, html, width, height, buttons, readOnly,language) {
	if (isIE) {
        ...
        switch(language) {
            ...
            default   :
               ...
               var alignLWord    = 'Aligné à gauche';
               var alignCWord    = 'Aligné au centre';
               var alignRWord    = 'Aligné à droite';
               var alignFWord    = 'Aligné justifié';
	...
	if (buttons == true) {
		...
		document.writeln('	<tr>');
		document.writeln('		<td>');
		document.writeln('			<select class="RTE" id="formatblock_' + rte + '" onchange="Select(\'' + rte + '\', this.id);">');
		...
		document.writeln('		</td>');
		document.writeln('		<td>');
		document.writeln('			<select class="RTE" id="fontname_' + rte + '" onchange="Select(\'' + rte + '\', this.id)">');
		...
		document.writeln('		</td>');
		document.writeln('		<td>');
		document.writeln('			<select class="RTE" unselectable="on" id="fontsize_' + rte + '" onchange="Select(\'' + rte + '\', this.id);">');
	...
	document.writeln('<iframe class="RTE" id="' + rte + '" name="' + rte + '" width="' + width + '" height="' + height + '"></iframe>');
	document.writeln('<input class="RTE" type="hidden" id="hdn' + rte + '" name="' + rte + '" value="">');
